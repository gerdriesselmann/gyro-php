...
<?php print html::info(tr('Please check, if the mail has been blocked as spam, before trying to resend.', 'users')); ?>
...
<form class="has_focus" id="frmresregmail" name="frmresregmail" action="<?=$url_self?>" method="post">
	...
	<br />
	<?php print WidgetInput::output('submit', '', tr('Resend', 'users'), WidgetInput::SUBMIT); ?>
</form>
