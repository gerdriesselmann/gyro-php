 ...
 */
class CSSYaml4EventSink implements IEventSink {
	/**
		...
		if ($event_name == 'jcssmanager_compress' || $event_name == 'jcssmanager_collect') {
			switch($event_params) {
				case JCSSManager::TYPE_CSS:
					$result[] = 'css/my_layout.css';
					break;					
				case JCSSManager::TYPE_CSS_IE7:
				case JCSSManager::TYPE_CSS_IE6:
					$result[] = 'css/patches/patch_my_layout.css';
					break;
			}
		}
	}
